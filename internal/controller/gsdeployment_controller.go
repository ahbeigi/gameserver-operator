...
// GSDeploymentReconciler reconciles a GSDeployment object
type GSDeploymentReconciler struct {
	client.Client
	Scheme *runtime.Scheme
}

// +kubebuilder:rbac:groups=game.example.com,resources=gsdeployments,verbs=get;list;watch;create;update;patch;delete
...
// the GSDeployment object against the actual cluster state, and then
